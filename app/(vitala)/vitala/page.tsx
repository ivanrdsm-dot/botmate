    ...
    <div className="space-y-20">
      ...
      <section className="relative pt-6 text-center">
        ...
        <Reveal delay={3}>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link href="/vitala/onboarding" className="rounded-full px-6 py-3 font-semibold text-black transition-transform hover:scale-105" style={{ background: C.brand }}>
              Crear mi plan gratis
            </Link>
            <Link href="/vitala/uno-peso" className="rounded-full border px-6 py-3 font-semibold transition-transform hover:scale-105" style={{ borderColor: C.accent, color: C.accent }}>
      ...
      <Reveal>
        ...
        >
          ...
          <Link href="/vitala/uno-peso" className="mt-6 inline-block rounded-full px-6 py-3 font-semibold text-black transition-transform hover:scale-105" style={{ background: C.accent }}>
