...
export const cases: CaseStudy[] = [
  {
    ...
    title: "Cómo 12 BotMate Serve elevaron el ticket promedio 18% en 6 meses",
    summary:
    ...
    hero: "restaurant",
    robots: ["BotMate Serve", "BotMate Carry"],
    challenge:
    ...
    solution:
      "Implementamos una flota mixta de 12 BotMate Serve para entrega de platillos y 4 BotMate Carry para retiro de loza. Integración con el POS para sincronizar pedidos y ruteo óptimo entre cocinas y mesas. Capacitación inmersiva de 3 días al equipo completo.",
    results: [
    ...
    scope: "12 BotMate Serve · 4 BotMate Carry · 7 sucursales",
  },
  {
    ...
    industry: "Hotelería",
    city: "Tulum, QROO",
    title: "Room service 24/7 con BotMate Tower en un hotel boutique de 84 llaves",
    summary:
    ...
    hero: "hotel",
    robots: ["BotMate Tower", "BotMate Glide"],
    challenge:
    ...
    solution:
      "Integración de 3 BotMate Tower con elevadores y PMS Opera. BotMate Glide para servicio en restaurante y bar de alberca. Compartimentos seguros con código por SMS para huéspedes.",
    results: [
    ...
    quote: {
      text: "BotMate Tower transformó nuestra operación nocturna. Los huéspedes se graban videos cuando llega el robot — se convirtió en contenido orgánico para redes sociales.",
      author: "Ricardo Sandoval",
      role: "Gerente General",
    },
    timeline: "Go-live en 21 días",
    scope: "3 BotMate Tower · 1 BotMate Glide · Integración PMS",
  },
  {
    ...
    industry: "Salud",
    city: "Monterrey, NL",
    title: "Distribución hospitalaria cero-contacto con BotMate Flex",
    summary:
    ...
    hero: "hospital",
    robots: ["BotMate Flex", "BotMate Clean"],
    challenge:
    ...
    solution:
      "8 BotMate Flex con compartimentos esterilizables para distribución intra-piso y entre áreas. 2 BotMate Clean para limpieza autónoma nocturna en pasillos y vestíbulos.",
    results: [
    ...
    scope: "8 BotMate Flex · 2 BotMate Clean · Integración con sistema farmacia",
  },
  {
    ...
    summary:
      "Una plaza comercial premium combinó publicidad interactiva con BotMate Ads y limpieza 4-en-1 con BotMate Clean para reducir costos operativos y crear nuevas fuentes de ingreso publicitario.",
    hero: "retail",
    robots: ["BotMate Ads", "BotMate Clean"],
    challenge:
    ...
    solution:
      "6 BotMate Ads como pantallas publicitarias rodantes con CMS dedicado, vendidas como espacio premium a marcas ancla. 4 BotMate Clean para limpieza autónoma off-peak.",
    results: [
      ...
      { label: "Tráfico convertido", value: "+12%", sub: "campañas con CTA en BotMate Ads" },
    ],
    quote: {
      text: "Convertimos un costo operativo en una unidad de negocio. BotMate Ads paga renta y aún genera utilidad.",
      author: "Eduardo Mejía",
      role: "Director Comercial",
    },
    timeline: "Lanzamiento en 28 días",
    scope: "6 BotMate Ads · 4 BotMate Clean · CMS publicitario",
  },
  {
    ...
    industry: "Logística",
    city: "Querétaro, QRO",
    title: "BotMate Cargo 600 para picking & packing en CEDIS de 18,000 m²",
    summary:
      "Una empresa 3PL en Querétaro redujo 61% el tiempo de picking en su centro de distribución usando una flota de robots autónomos BotMate Cargo 600 con integración WMS.",
    hero: "logistics",
    robots: ["BotMate Cargo 600", "BotMate Cargo 300"],
    challenge:
    ...
    solution:
      "12 BotMate Cargo 600 para mover tarimas entre racks y zona de empaque, 4 BotMate Cargo 300 para piezas medianas. Integración con WMS Manhattan y flota administrada por BotMate RMS.",
    results: [
    ...
    quote: {
      text: "Los BotMate Cargo 600 trabajan 22 horas al día sin queja. Pudimos triplicar capacidad sin construir un nuevo CEDIS.",
      author: "Andrés Carmona",
      role: "Director de Logística",
    },
    timeline: "Implementación en 45 días",
    scope: "12 BotMate Cargo 600 · 4 BotMate Cargo 300 · Integración WMS",
  },
  {
    ...
    solution:
      "1 BotMate Ads como anfitrión digital en lobby con check-in inteligente. 2 BotMate Clean + 3 BotMate Clean Mini para limpieza autónoma nocturna en pisos comunes y privados.",
    results: [
    ...
    scope: "1 BotMate Ads · 2 BotMate Clean · 3 BotMate Clean Mini · 14 pisos",
  },
];
