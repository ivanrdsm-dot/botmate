...
export const brandLogos: Record<string, {src:string; alt:string; dark?:boolean}> = {
 'L’Oréal':{src:'/media/brands/loreal.svg',alt:'L’Oréal'},
 Alpura:{src:'/media/brands/alpura.png',alt:'Alpura'},
 Walmart:{src:'/media/brands/walmart.webp',alt:'Walmart México y Centroamérica'},
 'Sam’s':{src:'/media/brands/sams.svg',alt:'Sam’s Club',dark:true},
 MPI:{src:'/media/brands/mpi.png',alt:'MPI Mexico Chapter'},
 Mabe:{src:'/media/brands/mabe.jpg',alt:'Mabe'},
 Purina:{src:'/media/brands/purina.png',alt:'Purina'},
 'Meximold 2026':{src:'/media/brands/meximold.png',alt:'Meximold',dark:true},
};
...
export type BotmateCase = {
  ...
  evidence: Localized; next: Localized; image: string; imageAlt: Localized; imageCaption: Localized;
};
...
export const botmateCases: BotmateCase[] = [
  {
    ...
    imageCaption:{es:'Archivo gráfico de Botmate · material de marca.',en:'Botmate graphic archive · brand artwork.'}, image:'/media/clientes/walmart-archivo.webp', imageAlt:{es:'Pieza gráfica original de Botmate con la marca Walmart',en:'Original Botmate brand artwork featuring Walmart'},
  },
  {
    ...
    imageCaption:{es:'Archivo gráfico de Botmate · material de marca.',en:'Botmate graphic archive · brand artwork.'}, image:'/media/clientes/purina-archivo.webp',imageAlt:{es:'Pieza gráfica original de Botmate con la marca Purina',en:'Original Botmate brand artwork featuring Purina'},
  },
  {
    image:'/media/display-field.webp', imageAlt:{es:'Robot con pantalla de Botmate en campo, como referencia del tipo de equipo',en:'Botmate screen robot in the field, illustrating the equipment type'}, imageCaption:{es:'Robot de Botmate · imagen de referencia, no fotografía de una activación de Mabe.',en:'Botmate robot · reference image, not a photograph of a Mabe activation.'},
  ...
  {
    image:'/media/pudu/f70fc5f9c3fcf47f.webp', imageAlt:{es:'PuduBot 2 en su configuración estándar de fábrica',en:'PuduBot 2 in its standard factory configuration'}, imageCaption:{es:'Imagen oficial del PuduBot 2 · configuración estándar de referencia; no muestra el montaje del evento.',en:'Official PuduBot 2 image · standard reference configuration; not the event setup.'},
