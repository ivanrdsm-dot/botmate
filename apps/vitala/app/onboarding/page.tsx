...
import { ACTIVITY_LABEL, GOAL_LABEL, validateProfile } from "@/lib/nutrition";
import { emptyProfile, loadProfile, saveProfile } from "@/lib/store";
import { getSupabase, saveProfileCloud } from "@/lib/supabase";
